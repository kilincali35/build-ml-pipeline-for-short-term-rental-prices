...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "basic_cleaning" in active_steps:
            _ = mlflow.run(
                #Below one is necessary because Hydra executes the script in a different directory than the root of the starter kit. 
        ...
        if "data_split" in active_steps:
            _ = mlflow.run(f"{config['main']['components_repository']}/train_val_test_split",
                entry_point = "main",
                #!!!!!Version is added to solve iterablelist origin/master error https://knowledge.udacity.com/questions/882091
                version="main",
                parameters={
        ...
        #This step is NOT run by default when you run the pipeline. 
        #In fact, it needs the manual step of promoting a model to prod before it can complete successfully. 
        #Therefore, you have to activate it explicitly on the command line:
